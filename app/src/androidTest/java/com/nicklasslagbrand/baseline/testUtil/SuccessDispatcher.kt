package com.nicklasslagbrand.baseline.testUtil

import android.content.Context
import android.net.Uri
import androidx.test.platform.app.InstrumentationRegistry
import com.nicklasslagbrand.baseline.testUtil.AssetReaderUtil.asset
...
class SuccessDispatcher(
    ...
    private val responseFilesByPath: Map<String, String> = mapOf(
            APIPaths.REPOS_LIST to MockFiles.REPOS_LIST_SUCCESS
    )
